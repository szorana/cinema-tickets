...
namespace CinemaTicket.Web.Controllers
{
    public class AccountController : Controller
    {
            ...
            if (ModelState.IsValid)
            {
                ...
                if (userCheck == null)
                {
                    var user = new TicketShopApplicationUser
                    {
                        ...
                        UserCart = new CinemaTickets.Domain.Domain.Cart()
                    };
        ...
        [HttpPost]
        public async Task<IActionResult> ManageRole(string Role)
        {
            ...
            {
                await userManager.RemoveClaimAsync(user, new Claim("UserRole", "Admin"));
            }
