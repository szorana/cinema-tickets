...
using CinemaTickets.Service;
using CinemaTickets.Service.Implenetation;
...
namespace CinemaTicket.Web
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            services.AddIdentity<TicketShopApplicationUser, IdentityRole>()
            .AddEntityFrameworkStores<ApplicationDbContext>()
